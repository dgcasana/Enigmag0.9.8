...
static const char* CONTROLLER_NAME = "Motion controller";
...
protected:
     ...
     */
    void buildHADiscoveryM ();
	void buildHADiscoveryS ();
    void buildHABinarySensorDiscoveryM ();
	void buildHABinarySensorDiscoveryS ();
