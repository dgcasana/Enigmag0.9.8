...
DeviceAddress termMezcla     =  { 0x28, 0xFF, 0x34, 0xB6, 0x51, 0x17, 0x04, 0x78 }; // {0x28, 0xBE, 0xF7, 0x95, 0xF0, 0x01, 0x3C, 0xC9}; //
DeviceAddress termRetAlta     =  { 0x28, 0xFF, 0x95, 0x6C, 0x53, 0x17, 0x04, 0xD3 }; // {0x28, 0xCD, 0x22, 0x95, 0xF0, 0x01, 0x3C, 0x84}; //
...
void CONTROLLER_CLASS_NAME::userCode(){
	// Read sensor data
		...
		if (0 < tempRetAlta) json["PAlta"] = tempRetAlta;
